...
//     {
//         try { return Ok(await _teams.GetByEventAsync(eventId, ct)); }
...
//     {
//         try { return Ok(await _teams.GetByIdAsync(id, ct)); }
//         catch (KeyNotFoundException) { return NotFound(); }
//     }
//
...
//     {
//         try { return Ok(await _teams.UpdateAsync(id, request, ct)); }
//         catch (KeyNotFoundException) { return NotFound(); }
//     }
//
